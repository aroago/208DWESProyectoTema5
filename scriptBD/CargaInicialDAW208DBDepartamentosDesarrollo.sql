...
-- Insertar datos en la tabla T01_Usuario de la base de datos DB208DWESProyectoTema5
...
-- Insertar datos en la tabla T02_Departamento de la base de datos DB208DWESProyectoTema5
INSERT INTO T02_Departamento (T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenDeNegocio) VALUES
    ('DAW','Departamento de DAW',null,18),
    ('DWES','Departamento de DWES',null,1.9),
    ('DWEC','Departamento de DWEC',null,35),
    ('DIW','Departamento de DIW',null,5.4),
    ('FOL','Departamento de FOL',null,45);